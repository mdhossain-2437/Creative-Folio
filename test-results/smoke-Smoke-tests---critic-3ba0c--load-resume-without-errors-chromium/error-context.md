...
- Name: smoke.spec.ts >> Smoke tests - critical routes >> should load /resume without errors
- Location: e2e\smoke.spec.ts:22:9

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/resume
Call log:
  - navigating to "http://localhost:3000/resume", waiting until "load"
