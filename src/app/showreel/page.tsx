...
export const metadata: Metadata = {
  ...
  description:
    "A vertical reel of selected work, 2025–2026. Six chapters, autoplay muted, click any chapter to scrub.",
};
    ...
    <>
      ...
      <section className="bg-ink-900 py-20 md:py-28">
        <div className="mx-auto max-w-[1640px] px-6 md:px-10">
          <ol className="space-y-px overflow-hidden border-y border-warmwhite/10">
            {reelClips.map((c) => (
              <li
                key={c.index}
              ...
              >
                <span className="col-span-2 font-mono text-[10px] uppercase tracking-widest text-warmwhite/45 md:col-span-1">
                  §{c.index}
                </span>
                <span className="col-span-7 font-serif text-2xl tracking-tight text-warmwhite md:col-span-7 md:text-4xl">
                  {c.title}
                </span>
                <span className="col-span-3 hidden font-mono text-[10px] uppercase tracking-widest text-warmwhite/45 md:col-span-3 md:block">
                  {c.topic}
                </span>
